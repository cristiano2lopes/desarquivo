...
INSERT OR IGNORE INTO category_dim (id, name) values ('cinema_on_theaters', 'Em cartaz');
INSERT OR IGNORE INTO category_dim (id, name) values ('image_of_the_day', 'Imagem do dia');
